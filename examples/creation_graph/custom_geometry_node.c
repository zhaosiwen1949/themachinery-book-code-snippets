...
// #code_snippet_begin(custom_geometry_node_data)
...
// #code_snippet_end(custom_geometry_node_data)
...
static void triangle_node__compile(tm_creation_graph_interpreter_context_t *ctx, tm_creation_graph_compile_context_t *compile_ctx)
{
    ...
    if (!context)
        return;
    // #code_snippet_begin(custom_geometry_node_call_info)
    ...
    *draw_call = (tm_renderer_draw_call_info_t){
    ...
    // #code_snippet_end(custom_geometry_node_call_info)

    tm_gpu_geometry_t *gpu_geometry = (tm_gpu_geometry_t *)geometry_wire_data;
    // #code_snippet_begin(vertex_buffer_system)
    ...
    // #code_snippet_end(vertex_buffer_system)
...
#include <the_machinery/shaders/vertex_buffer_system.inl>
        ...
        // #code_snippet_begin(create_resource)
        ...
        if (!node_cache->handles[0].resource)
        {
            ...
            // #code_snippet_end(create_resource)
            // #code_snippet_begin(vertex_data)
            ...
            // #code_snippet_end(vertex_data)
            // #code_snippet_begin(buffer_system)
            ...
            // #code_snippet_end(buffer_system)
        }
        // #code_snippet_begin(unlock)
